...
//  }
  ...
  createEmployer(String firstname, String lastname, String phonenb,
      String description, String city, AuthCredential authCreds) async {
    try {
      AuthResult result =
          await FirebaseAuth.instance.signInWithCredential(authCreds);
      FirebaseUser user = result.user;
      await DatabaseOperations(uid: user.uid)
          .updateEmployerData(firstname, lastname, phonenb, description, city);
  ...
  Future<void> verifyPhone(BuildContext context, String signInType, phoneNo,
    ...
    final PhoneVerificationCompleted verified =
      ...
      if (signInType == 'login') {
        ...
        AuthService().createEmployer(
            firstname, lastname, phoneNo, desc, city, authCredential);
